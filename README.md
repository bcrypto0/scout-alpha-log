...
|---|---|
| Events logged | **4,448** |
| Of which pre-listing config flips | **3,437** |
| Distinct tokens seen | **2,061** |
| Period covered | **2026-05-02 → 2026-08-14** (104 days) |
...
| Source | Events |
|---|---|
| `coin_config.gate` | 1,438 |
| `coin_config.mexc` | 1,232 |
| `coinbase` | 572 |
| `coin_config.kucoin` | 430 |
...
log <!--WOPEN-->**3,197 of 3,437 flagged rows (93%) have withdrawals open**<!--/WOPEN-->,
