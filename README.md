...
|---|---|
| Events logged | **8,063** |
| Of which pre-listing config flips | **6,856** |
| Distinct tokens seen | **2,351** |
| Period covered | **2026-05-02 → 2026-09-16** (137 days) |
...
| Source | Events |
|---|---|
| `coin_config.gate` | 4,490 |
| `coin_config.mexc` | 1,232 |
| `coin_config.binance` | 592 |
| `coinbase` | 591 |
| `coin_config.kucoin` | 542 |
| `okx` | 259 |
| `bybit` | 229 |
| `upbit` | 79 |
| `binance` | 37 |
...
log <!--WOPEN-->**6,575 of 6,856 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
