...
|---|---|
| Events logged | **3,661** |
| Of which pre-listing config flips | **2,705** |
| Distinct tokens seen | **1,996** |
| Period covered | **2026-05-02 → 2026-08-04** (94 days) |
...
| `coin_config.gate` | 736 |
| `coinbase` | 561 |
| `coin_config.kucoin` | 403 |
