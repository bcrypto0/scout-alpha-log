...
|---|---|
| Events logged | **6,720** |
| Of which pre-listing config flips | **5,585** |
| Distinct tokens seen | **2,265** |
| Period covered | **2026-05-02 → 2026-09-03** (124 days) |
| Average | ~54 events/day |
...
log <!--WOPEN-->**5,319 of 5,585 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
