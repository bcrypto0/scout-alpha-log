...
|---|---|
| Events logged | **7,288** |
| Of which pre-listing config flips | **6,129** |
| Distinct tokens seen | **2,293** |
| Period covered | **2026-05-02 → 2026-09-08** (129 days) |
| Average | ~56 events/day |
...
log <!--WOPEN-->**5,861 of 6,129 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
