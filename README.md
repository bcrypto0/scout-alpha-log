...
|---|---|
| Events logged | **6,792** |
| Of which pre-listing config flips | **5,647** |
| Distinct tokens seen | **2,276** |
| Period covered | **2026-05-02 → 2026-09-04** (125 days) |
...
log <!--WOPEN-->**5,380 of 5,647 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
