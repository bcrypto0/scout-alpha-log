...
|---|---|
| Events logged | **8,789** |
| Of which pre-listing config flips | **7,525** |
| Distinct tokens seen | **2,438** |
| Period covered | **2026-05-02 → 2026-09-25** (146 days) |
...
log <!--WOPEN-->**7,225 of 7,525 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
