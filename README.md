...
|---|---|
| Events logged | **4,562** |
| Of which pre-listing config flips | **3,526** |
| Distinct tokens seen | **2,088** |
| Period covered | **2026-05-02 → 2026-08-14** (105 days) |
...
log <!--WOPEN-->**3,286 of 3,526 flagged rows (93%) have withdrawals open**<!--/WOPEN-->,
