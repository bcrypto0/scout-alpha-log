...
|---|---|
| Events logged | **6,211** |
| Of which pre-listing config flips | **5,102** |
| Distinct tokens seen | **2,237** |
| Period covered | **2026-05-02 → 2026-08-30** (120 days) |
| Average | ~52 events/day |
...
log <!--WOPEN-->**4,836 of 5,102 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
