...
|---|---|
| Events logged | **4,850** |
| Of which pre-listing config flips | **3,806** |
| Distinct tokens seen | **2,097** |
| Period covered | **2026-05-02 → 2026-08-18** (108 days) |
| Average | ~45 events/day |
...
| Source | Events |
|---|---|
| `coin_config.gate` | 1,759 |
| `coin_config.mexc` | 1,232 |
| `coinbase` | 572 |
| `coin_config.kucoin` | 451 |
| `coin_config.binance` | 364 |
| `okx` | 199 |
| `bybit` | 173 |
| `upbit` | 65 |
| `binance` | 28 |
...
log <!--WOPEN-->**3,562 of 3,806 flagged rows (94%) have withdrawals open**<!--/WOPEN-->,
