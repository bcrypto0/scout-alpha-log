...
|---|---|
| Events logged | **6,094** |
| Of which pre-listing config flips | **4,985** |
| Distinct tokens seen | **2,236** |
| Period covered | **2026-05-02 → 2026-08-29** (119 days) |
...
log <!--WOPEN-->**4,719 of 4,985 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
