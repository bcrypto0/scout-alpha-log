...
|---|---|
| Events logged | **8,319** |
| Of which pre-listing config flips | **7,098** |
| Distinct tokens seen | **2,381** |
| Period covered | **2026-05-02 → 2026-09-19** (140 days) |
...
log <!--WOPEN-->**6,809 of 7,098 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
