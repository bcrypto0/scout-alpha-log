...
|---|---|
| Events logged | **5,339** |
| Of which pre-listing config flips | **4,268** |
| Distinct tokens seen | **2,186** |
| Period covered | **2026-05-02 → 2026-08-22** (112 days) |
...
log <!--WOPEN-->**4,010 of 4,268 flagged rows (94%) have withdrawals open**<!--/WOPEN-->,
