...
|---|---|
| Events logged | **5,610** |
| Of which pre-listing config flips | **4,536** |
| Distinct tokens seen | **2,189** |
| Period covered | **2026-05-02 → 2026-08-24** (114 days) |
| Average | ~49 events/day |
...
| Source | Events |
|---|---|
| `coin_config.gate` | 2,346 |
| `coin_config.mexc` | 1,232 |
| `coinbase` | 574 |
| `coin_config.binance` | 497 |
| `coin_config.kucoin` | 461 |
| `okx` | 209 |
| `bybit` | 186 |
| `upbit` | 70 |
| `binance` | 28 |
...
log <!--WOPEN-->**4,278 of 4,536 flagged rows (94%) have withdrawals open**<!--/WOPEN-->,
