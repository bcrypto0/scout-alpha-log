...
|---|---|
| Events logged | **7,039** |
| Of which pre-listing config flips | **5,890** |
| Distinct tokens seen | **2,282** |
| Period covered | **2026-05-02 → 2026-09-06** (127 days) |
...
log <!--WOPEN-->**5,622 of 5,890 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
