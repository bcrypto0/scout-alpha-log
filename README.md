...
|---|---|
| Events logged | **7,251** |
| Of which pre-listing config flips | **6,097** |
| Distinct tokens seen | **2,287** |
| Period covered | **2026-05-02 → 2026-09-07** (128 days) |
| Average | ~57 events/day |
...
log <!--WOPEN-->**5,829 of 6,097 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
