...
|---|---|
| Events logged | **5,050** |
| Of which pre-listing config flips | **3,995** |
| Distinct tokens seen | **2,167** |
| Period covered | **2026-05-02 → 2026-08-20** (110 days) |
...
log <!--WOPEN-->**3,738 of 3,995 flagged rows (94%) have withdrawals open**<!--/WOPEN-->,
