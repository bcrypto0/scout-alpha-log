...
|---|---|
| Events logged | **6,586** |
| Of which pre-listing config flips | **5,460** |
| Distinct tokens seen | **2,256** |
| Period covered | **2026-05-02 → 2026-09-02** (123 days) |
...
log <!--WOPEN-->**5,194 of 5,460 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
