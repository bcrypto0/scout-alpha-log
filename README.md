...
|---|---|
| Events logged | **8,693** |
| Of which pre-listing config flips | **7,431** |
| Distinct tokens seen | **2,436** |
| Period covered | **2026-05-02 → 2026-09-24** (145 days) |
...
log <!--WOPEN-->**7,131 of 7,431 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
