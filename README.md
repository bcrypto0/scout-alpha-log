...
|---|---|
| Events logged | **8,507** |
| Of which pre-listing config flips | **7,264** |
| Distinct tokens seen | **2,411** |
| Period covered | **2026-05-02 → 2026-09-22** (143 days) |
...
log <!--WOPEN-->**6,969 of 7,264 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
