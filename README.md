...
|---|---|
| Events logged | **6,358** |
| Of which pre-listing config flips | **5,249** |
| Distinct tokens seen | **2,237** |
| Period covered | **2026-05-02 → 2026-08-31** (121 days) |
...
log <!--WOPEN-->**4,983 of 5,249 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
