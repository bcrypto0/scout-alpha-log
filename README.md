...
|---|---|
| Events logged | **4,163** |
| Of which pre-listing config flips | **3,158** |
| Distinct tokens seen | **2,051** |
| Period covered | **2026-05-02 → 2026-08-11** (101 days) |
| Average | ~41 events/day |
...
| `coin_config.gate` | 1,174 |
| `coinbase` | 572 |
| `coin_config.kucoin` | 418 |
...
log <!--WOPEN-->**2,920 of 3,158 flagged rows (92%) have withdrawals open**<!--/WOPEN-->,
