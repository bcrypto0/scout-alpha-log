...
|---|---|
| Events logged | **8,581** |
| Of which pre-listing config flips | **7,330** |
| Distinct tokens seen | **2,421** |
| Period covered | **2026-05-02 → 2026-09-23** (144 days) |
...
log <!--WOPEN-->**7,030 of 7,330 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
