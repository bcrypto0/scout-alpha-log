...
|---|---|
| Events logged | **7,356** |
| Of which pre-listing config flips | **6,190** |
| Distinct tokens seen | **2,301** |
| Period covered | **2026-05-02 → 2026-09-09** (130 days) |
...
log <!--WOPEN-->**5,922 of 6,190 flagged rows (96%) have withdrawals open**<!--/WOPEN-->,
