...
|---|---|
| Events logged | **5,402** |
| Of which pre-listing config flips | **4,330** |
| Distinct tokens seen | **2,187** |
| Period covered | **2026-05-02 → 2026-08-23** (113 days) |
| Average | ~48 events/day |
...
log <!--WOPEN-->**4,072 of 4,330 flagged rows (94%) have withdrawals open**<!--/WOPEN-->,
