...
|---|---|
| Events logged | **6,889** |
| Of which pre-listing config flips | **5,740** |
| Distinct tokens seen | **2,281** |
| Period covered | **2026-05-02 → 2026-09-05** (126 days) |
| Average | ~55 events/day |
...
log <!--WOPEN-->**5,473 of 5,740 flagged rows (95%) have withdrawals open**<!--/WOPEN-->,
